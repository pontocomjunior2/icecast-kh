...
export ICECAST_RELAY_PASSWORD=${ICECAST_RELAY_PASSWORD}
export ICECAST_ADMIN_USER=${ICECAST_ADMIN_USER}
export ICECAST_ADMIN_PASSWORD=${ICECAST_ADMIN_PASSWORD}
...
export ICECAST_WEB_PORT=${ICECAST_WEB_PORT:-80}
